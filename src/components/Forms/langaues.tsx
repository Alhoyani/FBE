...
interface SocialProps {
  ...
  onUpdate: (updatedData: { languages: SocialEntry[] }) => void;
}
...
const Languages: React.FC<SocialProps> = ({ initialData, onUpdate }) => {
  ...
  return (
    <Formik
      ...
      onSubmit={(values) => {
        onUpdate({ languages: values.socialEntries });
      }}
    >
                                  ...
                                  <Box flex={1}>
                                    ...
                                    <Field
                                      ...
                                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                                        setFieldValue(`socialEntries[${index}].name`, e.target.value);
                                        const updatedEntries = [...values.socialEntries];
                                        updatedEntries[index].name = e.target.value;
                                        onUpdate({ languages: updatedEntries });
                                      }}
                                    />
                                  </Box>
                                </Box>
